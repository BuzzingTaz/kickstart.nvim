...
return {
  ...
  opts = {
    ...
    explorer = { enabled = true, replace_netrw = false }, -- https://github.com/folke/snacks.nvim/blob/main/docs/explorer.md
    indent = {
      enabled = true,
      char = '│',
      only_scope = false,
      ...
      sources = {
        zoxide = {
          confirm = function(picker, item)
            picker:close()
            if item and (item.file or item.text) then
              require('oil').open(item.file or item.text)
            end
          end,
        },
        colorschemes = {
